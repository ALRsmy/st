...
shadow.on('message', (message) => {
      ...
      .setColor("#000000") 
      .setDescription(`
:small_blue_diamond: ${prefix}wt     : واتشنق
:small_blue_diamond: ${prefix}pl     : بلي
:small_blue_diamond: ${prefix}li     : ليسنت
:small_blue_diamond: ${prefix}st     : ستريم
:small_blue_diamond: ${prefix}x      : مسح رسائلك 
:small_blue_diamond: ${prefix}f      : تفكيك
:small_blue_diamond: ${prefix}e      : يرسل الكلام بأيمبد
:small_blue_diamond: ${prefix}av     : يطلع صورتك او صورة اللي تمنشنه
:small_blue_diamond: ${prefix}setav  : تغيير صورتك 
:small_blue_diamond: ${prefix}off    : وضع اوفلاين
:small_blue_diamond: ${prefix}dnd    : وضع عدم الازعاج 
:small_blue_diamond: ${prefix}idle   : وضع خامل
:small_blue_diamond: ${prefix}on     : وضع اونلاين 
 ©shadow.`) 
   message.channel.sendEmbed(embed)
          message.delete(3000);   
   }
